# Operator Quickstart — Payment Institution Actor

Shortest path from clone to a verified local dry-run for **cloud-itonami-pi**.
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-pi.git
cd cloud-itonami-pi
```
...
- Blueprint governor key: `pi-governor`
- Source path: `src/pi/governor.cljk`
